...
typedef struct jvmtiInterface_1_ {
  ...
  /*   156 : Get Heap Info  */
  /*   Added by @rayandrews */
  jvmtiError (JNICALL *GetHeapInfoBeforeGC) (jvmtiEnv* env,
    char** value_ptr,
    jboolean ignore_extended);
} jvmtiInterface_1;
...
struct _jvmtiEnv {
  ...
  /*   Added by @rayandrews */
  jvmtiError GetHeapInfoBeforeGC(char** value_ptr, jboolean ignore_extended = false) {
    return functions->GetHeapInfoBeforeGC(this, value_ptr, ignore_extended);
  }
#endif /* __cplusplus */
};
